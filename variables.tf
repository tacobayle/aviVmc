...
variable "contentLibrary" {
  default = {
    ...
    files = ["/home/ubuntu/controller-20.1.1-9071.ova", "/home/ubuntu/bionic-server-cloudimg-amd64.ova"] # keep the avi image first and the ubuntu image in the second position // don't change the name of the Avi OVA file
  }
}
